...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed z-10 bg-opacity-40 bg-black text-white max-w-screen-xl rounded-md">
      ...
      <div className="navbar-end">
        <label onChange={toggleTheme} className="swap swap-rotate mr-4">
